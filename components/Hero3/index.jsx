        ...
        <>
            <div style={{ background: '#810709' }}>
                ...
                <Container fluid>
                    <Row>
                        <Col sm={4}>
                            <div style={{ background: '#FFFFFF', width: '100%', height: '400px', padding: '20px', borderRadius: '10px' }}>
                                <h3>Filter</h3>
                        ...
                        <Col sm={8}>
                            ...
                            <div style={{ background:'#EEEAE9' ,borderRadius:'10px', marginTop:'5px', padding:'10px',}}>
                                <Row style={{display:'flex', alignItems:'center'}}>

                                    <Col xs={12} md={6}>
                                        <h3>Lahore : 40 Hotels found</h3>
                                    </Col>
                                    <Col xs={8} md={6}>
                                        <div style={{ display: 'flex',float:'right', alignItems: 'center' }}>
                                            ...
                                            <div style={{ background: '#CBC7C6', marginLeft: '20px', padding :'5px', display: 'flex' ,borderRadius:'30px'}}>
                                                <h4>Recomended</h4>
                                                <FontAwesomeIcon icon={faCaretUp} style={{position: 'relative', left:'3px',top:'5px'}}/>
                                                <FontAwesomeIcon icon={faCaretDown} style={{ position: 'relative', right: '7px', top: '10px' }} />
                                            </div>
                                        </div>
                                    </Col>
